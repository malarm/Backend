...
import questionsLocalisation from './questionsLocalisation';
import review from './review';
import reviewDetail from './reviewDetail';
import reviewPageStaticContent from './reviewPageStaticContent';
...
const models = {
	...
	questionsLocalisation: questionsLocalisation(sequelize, DataTypes),
	review: review(sequelize, DataTypes),
	reviewDetail: reviewDetail(sequelize, DataTypes),
	reviewPageStaticContent: reviewPageStaticContent(sequelize, DataTypes)
};
